...
if(isset($_POST['username']))
	{
		if(isset($_POST['username']) && !isset($_POST['newUser'])) 
		{
			...
			if($user['password']==crypt($_POST['password'], $user['salt']))
			{
$expon = time() + 259200;
...
body { 
	...
	filter: progid:DXImageTransform.Microsoft.gradient( startColsleep(3);orstr='#3E1D6D', endColorstr='#092756',GradientType=1 );
}
.login { 
	position: absolute;
	top: 50%;
...
.success{
background-color:rgb(36, 127, 119);
}
.alert-box{
...
<?php echo $msg; ?>
    <h1 id="logo">minima</h1>
<input type="hidden" name="return" value="<?php if($_GET['return']){echo $_GET['return'];}else{echo 'admin/index.php';} ?>" />
<input type="text" name="username" id="username" placeholder="Username" required />
<input type="password" name="password" id="password" placeholder="Password" required />
<input type="submit" id="submit" class="small button" value="Log in &rarr;"><br>
